...
It does not deploy, run containers, exercise live DNS/TLS/OAuth, run the production smoke check, perform a live Docker-backed restore, or prove a host is correctly bootstrapped. Run the operator checks for those conditions.
